			...
			<div class="row pl-lg-5 h-100">
				<div class="col-12 page-title">
					...
					<div class="c-arrow text-center pl-4">
						<img class="img-fluid i-arrow f-1" src="/img/home/flecha1.png" style="margin-top: -10px" width="55">
					</div>
					...
					<div class="c-arrow" style="position: absolute;left: 60%;bottom: 60px;z-index: 2;right: -20%;">
