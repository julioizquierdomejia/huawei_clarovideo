	...
	<div class="row pl-lg-5" style="min-height: calc(100vh - 73px)">
			...
			<div class="row pl-lg-5 h-100">
				<div class="col-12 page-title">
					...
					<div class="c-arrow text-center pl-4">
						<img class="img-fluid i-arrow f-1 d-none d-md-block" src="/img/home/flecha1.png" style="margin-top: -10px" width="55">
					</div>
					...
					<div class="c-arrow arrow-participa">
						<img class="img-fluid i-arrow f-2 d-none d-md-block" src="/img/home/flecha2.png" width="150">
					</div>
					</div>
				</div>
			</div>
		...
		<div class="col-12 col-md-6 d-flex flex-column justify-content-between col-xl-4 py-2 py-xl-0 pl-lg-5">
			...
			<div class="c-arrow arrow-3">
				<img class="img-fluid i-arrow f-3 d-none d-md-block" src="/img/home/flecha3.png" width="120">
			</div>
		...
		<div class="col-12 col-md-6 d-flex flex-column justify-content-between col-xl-4 py-2 py-xl-0 pl-lg-5">
			<div class="c-arrow position-relative arrow-4">
				<img class="img-fluid i-arrow f-4 d-none d-md-block" src="/img/home/flecha4.png" width="320">
			</div>
			...
			<div class="c-arrow text-center mt-3 pl-4 pl-md-5">
				<img class="img-fluid i-arrow f-5 d-none d-md-block" src="/img/home/flecha5.png">
			</div>
